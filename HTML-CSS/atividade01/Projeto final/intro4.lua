...
local function gotoFase4()
	composer.gotoScene ("fase4")
end
...
function scene:create( event )
	...
	local bg = display.newImageRect (sceneGroup,"cenas/fase4.png", 1520/4, 1920/4)
	bg.x = display.contentCenterX
	bg.y = display.contentCenterY

	local botaoOk = display.newRoundedRect (sceneGroup, display.contentCenterX, 391, 100, 25, 10)
	botaoOk.alpha = 0.01
	botaoOk:addEventListener ("tap", gotoFase4)
